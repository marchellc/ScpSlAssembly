...
namespace CommandSystem.Commands.RemoteAdmin.PermissionsManagement.Group
{
	...
	public class GrantCommand : ICommand, IUsageProvider
	{
		...
		public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
		{
			...
			text4 += "]";
			ServerLogs.AddLog(ServerLogs.Modules.Administrative, string.Concat(new string[] { sender.LogName, " granted permission ", text2, " to group ", text, "." }), ServerLogs.ServerLogType.RemoteAdminActivity_Misc, false);
