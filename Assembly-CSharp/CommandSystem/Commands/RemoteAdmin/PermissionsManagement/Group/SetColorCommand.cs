...
namespace CommandSystem.Commands.RemoteAdmin.PermissionsManagement.Group
{
	...
	public class SetColorCommand : ICommand, IUsageProvider
	{
		...
		public string[] Usage { get; } = new string[] { "Group Name", "Color" };
		...
		public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
		{
			...
			ServerLogs.AddLog(ServerLogs.Modules.Administrative, string.Concat(new string[] { sender.LogName, " set color of group ", text, " to ", colorName, "." }), ServerLogs.ServerLogType.RemoteAdminActivity_Misc, false);
