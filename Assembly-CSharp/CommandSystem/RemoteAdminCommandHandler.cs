...
public class RemoteAdminCommandHandler : CommandHandler
{
	...
	public override void LoadGeneratedCommands()
	{
		...
		this.RegisterCommand(new ExecuteAsCommand());
		...
		this.RegisterCommand(new ScaleCommand());
		...
		this.RegisterCommand(new SetMaxHealthCommand());
		...
		this.RegisterCommand(new VisualizeCollidersCommand());
		...
		this.RegisterCommand(new CustomKeycardCommand());
		...
		this.RegisterCommand(DmsCommand.Create());
