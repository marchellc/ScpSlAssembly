...
namespace PlayerRoles.PlayableScps.Scp939
{
	...
	public class Scp939LungeAudio
	{
		...
		{
			lunge.OnStateChanged += this.OnStateChanged;
		...
		private void OnStateChanged(Scp939LungeState state)
		{
			...
			case Scp939LungeState.LandHit:
				this.Play(this._hits.RandomItem<AudioClip>(), 25f);
				break;
		...
		{
			AudioSourcePoolManager.PlayOnTransform(clip, this._t, dis, 1f, FalloffType.Exponential, MixerChannel.DefaultSfx, 1f);
		}
