...
public class Scp079KeyAbilityGui : Scp079GuiElementBase
{
	...
	{
		float y = (createSpace ? this._rescaleParams.x : this._rescaleParams.y);
		this._rescaleTransform.sizeDelta = new Vector2(this._rescaleParams.z, y);
		base.gameObject.SetActive(value: true);
		this.SetupKeycode(NewInput.GetKey(key));
