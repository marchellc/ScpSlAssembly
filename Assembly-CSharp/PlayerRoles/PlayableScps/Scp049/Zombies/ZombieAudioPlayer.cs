...
namespace PlayerRoles.PlayableScps.Scp049.Zombies
{
	public class ZombieAudioPlayer : SubroutineBase
	{
		...
		{
			this.GrowlTimer.Trigger((double)global::UnityEngine.Random.Range(11.25f, 7.5f));
			this.ServerSendSound(this._visionTracker.LookingAtTarget ? ZombieAudioPlayer.Scp0492SoundId.AngryGrowl : ZombieAudioPlayer.Scp0492SoundId.Growl);
		}
		...
		protected override void Awake()
		{
			...
			foreach (ZombieAudioPlayer.Scp0492Sound scp0492Sound in this._sounds)
			{
		...
		public void ServerSendSound(ZombieAudioPlayer.Scp0492SoundId soundId)
		{
			this._soundToSend = (byte)soundId;
			this._lastPos = (base.Role as ZombieRole).FpcModule.Position;
			ZombieAudioPlayer.Scp0492Sound scp0492Sound;
			if (!ZombieAudioPlayer.Sounds.TryGetValue(this._soundToSend, out scp0492Sound))
			{
				return;
			}
			float disSqr = scp0492Sound.MaxDistance * scp0492Sound.MaxDistance;
		...
		private static readonly Dictionary<byte, ZombieAudioPlayer.Scp0492Sound> Sounds = new Dictionary<byte, ZombieAudioPlayer.Scp0492Sound>();

		public readonly AbilityCooldown GrowlTimer = new AbilityCooldown();

		[SerializeField]
		private ZombieAudioPlayer.Scp0492Sound[] _sounds;
		...
		{
			public ZombieAudioPlayer.Scp0492SoundId Id;
