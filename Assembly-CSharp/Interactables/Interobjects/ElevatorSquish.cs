...
namespace Interactables.Interobjects
{
	public class ElevatorSquish : NetworkBehaviour
	{
		private void Awake()
		{
			...
			this._pitKiller.OnEffectApplied += this.OnSquished;
		}
		...
		private void PlaySquishSound(Vector3 position)
		{
			...
			this.SendRPCInternal("System.Void Interactables.Interobjects.ElevatorSquish::PlaySquishSound(UnityEngine.Vector3)", -736738208, networkWriterPooled, 0, true);
		...
		{
			AudioSourcePoolManager.PlayAtPosition(this._squishSound, position, this._squishRange, 1f, FalloffType.Exponential, MixerChannel.DefaultSfx, 1f);
		}
		...
		{
			RemoteProcedureCalls.RegisterRpc(typeof(ElevatorSquish), "System.Void Interactables.Interobjects.ElevatorSquish::PlaySquishSound(UnityEngine.Vector3)", new RemoteCallDelegate(ElevatorSquish.InvokeUserCode_PlaySquishSound__Vector3));
		}
