...
namespace InventorySystem.Items.ThrowableProjectiles
{
	public class SingleTrajectoryProjectile : ThrownProjectile
	{
		...
		protected override PickupPhysicsModule DefaultPhysicsModule
		{
			get
			{
				return new TrajectoryPhysics(this);
			}
		}

		protected TrajectoryPhysics TrajPhysics
		{
			get
			{
				return base.PhysicsModule as TrajectoryPhysics;
			}
		}

		protected virtual bool AlreadyCollided
		{
			get
			{
				return this.TrajPhysics.DestinationReached;
			}
		}
		...
		protected virtual void Update()
		{
			...
			{
				this._destroyedObject.SetActive(true);
