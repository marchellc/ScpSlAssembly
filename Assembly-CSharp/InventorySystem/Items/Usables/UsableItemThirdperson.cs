...
namespace InventorySystem.Items.Usables
{
	public class UsableItemThirdperson : IdleThirdpersonItem, ILookatModifier
	{
		...
		protected virtual float IncreaseWeightSpeed
		{
			get
			{
				return 8f;
		...
		protected virtual float DecreaseWeightSpeed
		{
			get
			{
				return 5f;
		...
		protected override void Update()
		{
			...
			HybridLayerProcessor hybridLayerProcessor;
			if (base.TryGetLayerProcessor<HybridLayerProcessor>(out hybridLayerProcessor))
			{
				hybridLayerProcessor.SetDualHandBlend(this.CurWeight);
			}
		}
		...
		{
			UsableItemsController.OnClientStatusReceived += this.OnClientStatusReceived;
		}
