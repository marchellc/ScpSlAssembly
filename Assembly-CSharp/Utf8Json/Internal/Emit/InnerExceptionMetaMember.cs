...
namespace Utf8Json.Internal.Emit
{
	internal class InnerExceptionMetaMember : MetaMember
	{
		...
		private static readonly MethodInfo getInnerException = ExpressionUtility.GetPropertyInfo<Exception, Exception>((Exception ex) => ex.InnerException).GetGetMethod();

		private static readonly MethodInfo nongenericSerialize = ExpressionUtility.GetMethodInfo<JsonWriter>((JsonWriter writer) => JsonSerializer.NonGeneric.Serialize(writer, null, null));
